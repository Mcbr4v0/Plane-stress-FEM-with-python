...
for N in range(1, 51):
    ...
    boundary_conditions = Polygones.boundry(N, 'left', [0, 0])  # create the boundary conditions, the left side is fixed
    ...
    start_time = time.time()
    lower_bandwidth, upper_bandwidth = Polygones.test_bandiwth(K)  # calculate the bandwidth
